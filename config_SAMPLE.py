REPORT_NAME     = 'on.dashboard.dmr.gru'           # Name of the monitored HBlink system
#
CONFIG_INC      = False                           # Include HBlink stats
HOMEBREW_INC    = False                           # Display Homebrew Peers status
...
#
HBLINK_IP       = '10.132.0.6'                    # HBlink's IP Address
HBLINK_PORT     = 4321                           # HBlink's TCP reporting socket
FREQUENCY       = 3                             # Frequency to push updates to web clients
